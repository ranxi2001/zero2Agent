---
name: content-review
description: 审查 zero2Agent 项目中的文章内容质量。当用户说"审查文章"、"review内容"、"检查这篇文章写得怎么样"、"看看这篇符不符合项目风格"、"帮我看看内容质量"时触发。负责对照项目风格标准进行结构化评审，输出具体的改进建议。即使用户只是说"帮我看看写得怎么样"，只要涉及 zero2Agent 的 Markdown 文章，也应当触发此技能。
---
