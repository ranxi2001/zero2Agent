...
- 社区 [Plugin Marketplace](https://github.com/bradeGithub/DSH-Plugins-Marketplace) 索引 3,900+ DSH 专用插件和 14,000+ 通用 Skills
...
参考官方 [Architecture](https://github.com/deepseek-ai/deepseek-harness/blob/dsh-v0.1.0-rc.8/docs/architecture.zh.md)。社区解读文章（如 [DeepSeek Harness Agent OS](https://blog.anionex.me/archives/deepseek-harness-agent-os)）可作为阅读线索，但实现细节可能与当前版本不同，以官方仓库为准。
